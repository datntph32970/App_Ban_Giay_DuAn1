...
{
    public partial class Frm_NhanVien2 : UserControl
    {
        public Frm_NhanVien2()
        {
        ...
        {
            int stt = 1;
            dtgHienthi.ColumnCount = 13;
            dtgHienthi.Columns[0].Name = "STT";
            dtgHienthi.Columns[1].Name = "Mã";
            dtgHienthi.Columns[2].Name = "UserName";
            dtgHienthi.Columns[3].Name = "Password";
            dtgHienthi.Columns[4].Name = "Tên";
            dtgHienthi.Columns[5].Name = "Giới tính";
            dtgHienthi.Columns[6].Name = "SĐT";
            dtgHienthi.Columns[7].Name = "Địa chỉ";
            dtgHienthi.Columns[8].Name = "Email";
            dtgHienthi.Columns[9].Name = "Ngày sinh";
            dtgHienthi.Columns[9].DefaultCellStyle.Format = "dd/MM/yyyy";
            dtgHienthi.Columns[10].Name = "Chức vụ";
            dtgHienthi.Columns[11].Name = "Ngày tạo";
            dtgHienthi.Columns[11].DefaultCellStyle.Format = "dd/MM/yyyy";
            dtgHienthi.Columns[12].Name = "Trạng thái";
            ...
            foreach (var x in _service.GetTaikhoan(search))
            {
                ...
                dtgHienthi.Rows.Add(stt++, x.Mataikhoan, x.Username, x.Pasword, x.Hovaten, x.Gioitinh == true ? "Nam" : "Nữ", x.Sodienthoai
        ...
        private void dtgHienthi_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            _idWhenclick = int.Parse(dtgHienthi.Rows[index].Cells[1].Value.ToString());
        ...
        private void dtgHienthi_CellBeginEdit(object sender, DataGridViewCellCancelEventArgs e)
        {
            if (e.ColumnIndex == dtgHienthi.ColumnCount - 1)
            {
                e.Cancel = true;
            }
        }
