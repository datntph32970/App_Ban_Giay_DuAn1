...
{
    public partial class Frm_SanPham2 : UserControl
    {
        public Frm_SanPham2()
        {
            InitializeComponent();
        ...
        public void LoadDataGridView(string? txtTimKiem, string? SearchType)
        {
            ...
            dgv_Objects.ColumnCount = 16;
            dgv_Objects.Columns[0].Name = "STT";
            dgv_Objects.Columns[1].Name = "Mã giày";
            dgv_Objects.Columns[2].Name = "Mã giày chi tiết";
            dgv_Objects.Columns[3].Name = "Mã chất liệu";
            dgv_Objects.Columns[4].Name = "Mã màu sắc";
            dgv_Objects.Columns[5].Name = "Mã kích cỡ";
            dgv_Objects.Columns[6].Name = "Mã thương hiệu";
            dgv_Objects.Columns[7].Name = "Mã kiểu dáng";
            dgv_Objects.Columns[8].Name = "Ngày tạo";
            dgv_Objects.Columns[9].Name = "Mã người tạo";
            dgv_Objects.Columns[10].Name = "Ngày sửa";
            dgv_Objects.Columns[11].Name = "Mã người sửa gần nhất";
            dgv_Objects.Columns[12].Name = "Giá";
            dgv_Objects.Columns[13].Name = "Mô tả";
            dgv_Objects.Columns[14].Name = "Số lượng trong kho";
            dgv_Objects.Columns[15].Name = "Trạng thái";
