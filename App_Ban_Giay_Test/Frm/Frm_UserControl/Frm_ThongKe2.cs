...
{
    public partial class Frm_ThongKe2 : UserControl
    {
        public Frm_ThongKe2()
        {
        ...
        public void LoadGrid()
        {
            ...
            dataGridView1.Columns[2].Name = "Số lượng bán";
            dataGridView1.Columns[3].Name = "Tổng tiền";
            dataGridView1.Columns[4].Name = "Ngày tạo";
            ...
            {
                dataGridView1.Rows.Add(stt++, sanpham.Key, sanpham.Value.Item1, sanpham.Value.Item2, "N/A");
            }
